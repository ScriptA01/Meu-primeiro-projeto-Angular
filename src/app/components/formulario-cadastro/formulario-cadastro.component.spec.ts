...
describe('FormularioCadastroComponent', () => {
    ...
    cadastrarImovel(dados: any) {
      return {
        subscribe: (callbacks: any) => {
          callbacks.next({ sucesso: true }); // simula uma resposta de sucesso
        }
      };
    }
  }
  ...
  describe('FormularioCadastroComponent', () => {
    ...
    it('deve chamar cadastrarImovel com os dados corretos convertendo valor em número', () => {
      ...
      component.valor = '500.000,75'; // valor formatado
